<?php
// Konfiguracijska skripta redirecting korisnika ,definiranje konstanti i podesen error_handler , ali bez session_start 
// potreban za db_cart_checkout_stock_example.php skriptu
$live = false;
